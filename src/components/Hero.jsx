    ...
    <section className="font-mincho">
      ...
      <div className="relative flex items-center justify-between max-w-6xl mx-auto">
        <div className="flex-1 max-w-7xl space-y-4">
          ...
          <div className="space-x-12 flex justify-center items-center pt-8">
            <button 
        ...
        <div className="flex-1 flex ml-4 justify-end items-center mt-40">
          <div className="relative">
            <img
              src="/saikiblue.png"
              alt="Kotonami Character"
              className="max-w-full h-auto max-h-[80vh] drop-shadow-4xl"
