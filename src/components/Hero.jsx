...
export default function Hero() {
  return (
    <section className="min-h-screen font-mincho text-white bg-[url('/bg3.png')] bg-cover bg-bottom relative">
      <Navbar />
      <div className="absolute inset-0 bg-black/60 opacity-80 z-0" />
      <div className="relative z-10 max-w-4xl text-center space-y-4">
        ...
        <button  className="px-8 py-3 bg-white/10 backdrop-blur-xl text-white border border-white/30 rounded-xl hover:bg-white/20 hover:border-white/50 transition-all duration-300 flex items-center justify-center gap-2">Explore now</button>
        <button  className="px-8 py-3 bg-white/10 backdrop-blur-xl text-white border border-white/30 rounded-xl hover:bg-white/20 hover:border-white/50 transition-all duration-300 flex items-center justify-center gap-2">Get started</button>
        </div>
      </div>
    </section>
  );
